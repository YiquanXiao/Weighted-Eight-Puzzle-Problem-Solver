...
class EightPuzzleBoard:
    ...
    def __init__(self, board_string, mods=None):
        ...
        # predecessor record the predecessor of current state
        self.predecessor = None
        # cost record the total cost so far(path cost)
        self.cost = 0
        # op record the operation made to the predecessor state
        self.op = ''
        # # heuristic record the heuristic of current state
        # self.heuristic = 0
